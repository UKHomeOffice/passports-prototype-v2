var values = {
    ...
    "address-postcode": "NW1 5RD",
    "town-city": "London",
    "phone-number": "02081234567",
    "reference": "1234567890",
    "email-address": "roderickt@kainos.com",
    "email-confirm": "roderickt@kainos.com",
    "csig-name": "Adrian",
    "csig-last-name": "Brereton",
    "ref-name": "Adrian",
    "ref-middlename": "Alan",
    "ref-lastname": "Brereton",
    "ref-address-postcode": "SE1 7XH",
    "csig-email": "adrianb@kainos.com",
    "csig-email-confirm": "adrianb@kainos.com",
    ...
    "parent1-last-name": "Tan",
    "parent2-first-names": "Daniel",
    "parent2-last-name": "Tan",
    "marriage-day": "06",
    "marriage-month": "02",
    "marriage-year": "1978",
...
function clicks() {
    ...
    // Third party 
    localStorage.journey === 'FTA' ? $('#application-for-someone-else-false').click() : $('#application-for-someone-else-true').click();
