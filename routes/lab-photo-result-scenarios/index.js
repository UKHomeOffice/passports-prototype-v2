...
app.get('/lab-photo-result-scenarios/participant-7b', function (req, res, next) {
    res.render('lab-photo-result-scenarios/participant-7b');
});
...
app.get('/lab-photo-result-scenarios/participant-8b', function (req, res, next) {
    res.render('lab-photo-result-scenarios/participant-8b');
});
