...
ConfirmForm.prototype.createBreakdown = function (req, values, callback) {
    ...
    newPassportFields.push(
      /*  {
        ...
        {
            title: 'Your photo',
            custom: '<div class="photo"><img src="../../public/images/photo/result/thumbnail-teen-age-12-15-pass.jpg" alt="Your uploaded photo" title="Your uploaded photo" width="150"></div>'
        },
        {
        ...
        fields: [
            ...
            },
            {
                ...
                value: function() {
                  ...
                  output += '<br/><br/>';
                  output += join(values, ['application-country-code', 'mobile-overseas']);
                  return output;
                }
            },
            {
